...
counts <- read.table(
  "GSE64018_countlevel_12asd_12ctl.txt.gz",
  header = TRUE,
  row.names = 1
)
...
cat("Genes sem símbolo após org.Hs.eg.db:", length(missing_after_orgdb), "\n")
...
plot(volcano_df$log2FoldChange,
     ...
     main = "Volcano Plot: Inflamatory vs Neuronal")
...
dotplot(ego_inf, showCategory = 15, title = "GO - Inflamatório")
